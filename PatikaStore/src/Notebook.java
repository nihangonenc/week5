...
public class Notebook extends Product implements Operation {
    ...
    public void deleteProduct() {
        ...
        //show product ı çalıştırıp silmek istediği ürün idsi seçip collection remove metoduyla kaldırırız.

    }

    @Override
    public void filterByProductId() {
        //kullanıcıya listeleriz. id seçtiririz. collection get metoduyla id gösteririr.

    }

    @Override
    public void filterByProductBrand() {
        //kullanıcıdan örnek asus markayı aldıktan sonra bi for döngüsüyle netbooklist dönüp ismi asusa eşit olanları dönüp kullanıcıya gösteririz.
